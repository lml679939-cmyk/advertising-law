...
## 已確認的 `page` 欄位頁碼對照（期末考，2026-06-14 更新）

依 PDF 講義確認，格式為 `"p.XX 法條"`：
...
| 衛廣法§31 | 116 | 消保法§11 | 132 |
| 衛廣法§35 | 117 | 消保法§11-1 | 132 |
| 衛廣法§36 | 117 | 消保法§12 | 132 |
| 衛廣法§39 | 118 | 消保法§15 | 133 |
| 衛廣法§44 | 119 | 消保法§17 | 133 |
| 公平法§1 | 149 | 消保法§19 | 134 |
| 公平法§2 | 149 | 消保法§20 | 134 |
| 公平法§7 | 149 | 消保法§19-2 | 135 |
| 公平法§8 | 150 | 消保法§21 | 135 |
| 公平法§10 | 150 | 消保法分期付款 | 135 |
| 公平法§11 | 151 | 消保法§23 | 136 |
| 公平法§13 | 153 | 消保法§37 | 139 |
| 公平法§14 | 152 | 消保法§45-5 | 141 |
| 公平法§16 | 154 | 消保法§51 | 142 |
| 公平法§19 | 154 | 贈品贈獎辦法§4 | 170 |
| 公平法§22 | 155 | 贈品贈獎辦法§5 | 170 |
| 公平法§25 | 156 | 贈品贈獎辦法§6 | 170 |
| 公平法§28 | 156 | 移送主管機關類型表 | 175 |
| 公平法§29 | 157 | 處理原則附表二第11項 | 176 |
| 公平法§31 | 157 | 處理原則附表二第12項 | 176 |
| 公平法§32 | 157 | 處理原則附表二第21項 | 176 |
| 公平法§42 | 159 | 處理原則附表二第29項 | 176 |
| 公平法§45 | 159 | 處理原則附表二第23項 | 177 |
| 公平法§47-1 | 159 | 更正廣告處理原則 | 178 |
| 公平法§48 | 160 | 薦證廣告規範第2點 | 182 |
| 處理原則§4 | 172 | 薦證廣告規範§3 | 183 |
| 處理原則§5§6 | 172 | 薦證廣告規範第3點 | 183 |
| 處理原則§6 | 172 | 薦證廣告規範§4 | 185 |
| 處理原則§7 | 173 | 薦證廣告規範§5 | 186 |
| 處理原則§8 | 173 | 薦證廣告規範§6 | 186 |
| 網路廣告處理原則§4 | 190 | 比較廣告處理原則§5 | 188 |
| 網路廣告處理原則§8 | 191 | 比較廣告處理原則§6 | 188 |
| 網路廣告處理原則§9 | 191 | 比較廣告處理原則第8點 | 189 |
| 網路廣告處理原則§10 | 192 | 民法意思表示 | 200 |
| 網路關鍵字廣告處理原則 | 193 | 歐盟數位服務法DSA | 202 |

> **條次說明**：薦證廣告規範「第X點」為規範文件內部段落編號，§X 為對應公平法條文。「第2點」=廣告薦證者定義（p.182）；「第3點」=真實原則（p.183，同§3頁）；「第8點」=比較廣告移送檢察程序（p.189）。兩種格式並存於題庫，matchPages 均已補齊。

**不在 PDF 中的法規（2026-06-15 起加 `（衍生法規/考古題）` 後綴標注，共 7 組）：**
`衛廣法施行細則§11（衍生法規/考古題）`、`衛廣法施行細則§12（衍生法規/考古題）`、`廣告插播辦法§3（衍生法規/考古題）`、`衛廣法相關辦法§5（衍生法規/考古題）`、`警告函處理原則§3（衍生法規/考古題）`、`警告函處理原則§5（衍生法規/考古題）`、`購物頻道插播式字幕管理辦法§4（衍生法規/考古題）`

另有 `消保法§47` 無頁碼但未標注（題數少，維持純法條格式）。

> **matchPages 不受影響**：概念地圖使用 `q.page.includes(p)` 部分比對，後綴不破壞篩題邏輯。新增衍生法規題目時，page 格式應加後綴；matchPages 仍填不含後綴的短格式（如 `'警告函處理原則§3'`）。
